...
<head>
    ...
    <title>Alondra - Iniciar Sesión</title>
    ...
    <style>
        * {
        ...
        .login-container {
            ...
            padding: 35px; /* Reducir padding general del contenedor */
            width: 100%;
            max-width: 420px;
            position: relative;
            overflow: hidden;
        ...
        .logo-container {
            text-align: center;
            margin-bottom: 20px; /* Reducir espacio entre logo y título */
            background: 
            ...
            border-radius: 20px; /* Reducir border-radius */
            padding: 25px 20px; /* Reducir padding para hacer el contenedor más pequeño */
            box-shadow: 
        ...
        .logo-img {
            max-width: 160px; /* Reducir el tamaño del logo para mejor proporción */
            height: auto;
            position: relative;
            z-index: 2;
...
<body>
    <div class="login-container">
        ...
        <p class="login-subtitle">Accede a tu sistema de gestión académica</p>
